...
class MainWindow(QMainWindow):
    ...
    def insert(self):
        # Instantiates insert  and search dialog classes
        dialog = InsertDialog()
        dialog.exec()
...
class SearchDialog(QDialog):
    ...
    def search(self):
        name = self.student_name.text()
        # Access the table of main_window object of QTable widget type
        # Qtable widget has findItems method
        # The Qt flag matches the name string
